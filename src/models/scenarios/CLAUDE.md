...
> ⬆️ [返回 models/](../CLAUDE.md) · 📋 相关: [agent/](../../agent/CLAUDE.md) · [controllers/](../../controllers/CLAUDE.md)
...
graph LR
    ...
    Server["controllers/server/<br/>Express"]
    Client["views/<br/>React"]
    ...
    Client -->|"GET /api/scenarios"| Registry
...
graph TD
    ...
    Tools -->|"可选 import"| Confirm["agent/hitl/hitl.ts<br/>withConfirm()"]
    Tools --> Validator
    Tools --> API
...
> 完整定义见 [domain/interfaces/IScenario.ts](../domain/interfaces/IScenario.ts)
...
- [agent/hitl/hitl.ts](../../agent/CLAUDE.md) — 按需使用 withConfirm
- [models/domain/interfaces/IScenario.ts](../domain/CLAUDE.md) — Scenario 接口

## 约束

- ❌ 不 import `../../controllers/` 或 `../../views/`
- ✅ 可 import `../../agent/hitl/hitl.js`
- ✅ 可 import `../domain/`

---

> ⬆️ [返回 models/](../CLAUDE.md) · ⬇️ [leave-approval](leave-approval/CLAUDE.md) · [expense-approval](expense-approval/CLAUDE.md) · [sick-leave](sick-leave/CLAUDE.md) · [pure-chat](pure-chat/CLAUDE.md) · [faq](faq/CLAUDE.md) · [oncall](oncall/CLAUDE.md)