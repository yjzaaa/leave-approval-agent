...
> ⬆️ [返回项目根目录](../../CLAUDE.md) · 📋 依赖: [domain/](../domain/CLAUDE.md) · [infrastructure/](../infrastructure/CLAUDE.md) · [agent/](../agent/CLAUDE.md) · [scenarios/](../scenarios/CLAUDE.md)
...
│   └── plugins.ts         # GET /api/plugins — 场景列表
...
graph TD
    ...
    Controllers -->|"调用"| Registry["scenarios/registry"]
...
- [scenarios/registry.ts](../scenarios/CLAUDE.md) — 场景注册表
- [domain/interfaces/](../domain/CLAUDE.md) — IScenario, ITracer
...
> ⬆️ [返回项目根目录](../../CLAUDE.md) · 📋 依赖: [agent/](../agent/CLAUDE.md) · [scenarios/](../scenarios/CLAUDE.md)
